...
[[file:./Aclaraciones/SobreLaSolucionDeAlgunasPreguntas.pdf][Aclaración sobre la solución de algunas preguntas tipo test]]

* Ficheros de prácticas

- Ficheros con [[https://github.com/mbujosab/Ectr/tree/master/Practicas/Gretl][prácticas de Gretl]] para cada [[file:Practicas/Gretl/index.org][lección]].
